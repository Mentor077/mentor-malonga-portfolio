<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tr>
    <!-- Colonne Image : Cadrage visage et Bordure Marron -->
    ...
    <!-- Colonne Texte : Alignement millimétré avec le haut de la photo -->
    <td valign="top" style="padding: 0;">
      <h1 style="margin: 0 0 8px 0; color: #8B4513; font-size: 26px; line-height: 1; padding-top: 2px;">⚡ Mentor MALONGA ⚡</h1>
      <h2 style="margin: 0 0 10px 0; color: #5D2E0A; font-size: 19px; line-height: 1.2;"><b>Data Analyst Senior &amp; Channel Supervisor</b></h2>
      <p style="margin: 0 0 15px 0; color: #777; font-size: 15px;"><i>Expert Big Data, BI &amp; Opérations Retail</i></p>
...
<hr style="border: none; border-top: 2px solid #8B4513; margin: 25px 0;">
...
<h3 style="color: #8B4513; margin-bottom: 15px;">📊 Matrice de Valeur Ajoutée (Core Value)</h3>

<table border="1" cellspacing="0" cellpadding="10" style="border-collapse: collapse; border: 2px solid #8B4513; width: 100%; text-align: left; font-size: 14px;">
  <thead>
    <tr style="background-color: #FDF5E6;">
      <th style="border: 1px solid #8B4513; color: #5D2E0A;">📈 STRATÉGIE &amp; DISTRIBUTION</th>
      <th style="border: 1px solid #8B4513; color: #5D2E0A;">📦 BIG DATA &amp; ANALYTICS</th>
      <th style="border: 1px solid #8B4513; color: #5D2E0A;">🎯 PILOTAGE DE PROJETS</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td style="border: 1px solid #8B4513; vertical-align: top;">• **Channel Supervision** (2 ans)<br>• Management d'équipes de vente (SR)<br>• Suivi de la performance du réseau</td>
      <td style="border: 1px solid #8B4513; vertical-align: top;">• Traitement de données avec **PySpark**<br>• Manipulation avec **Python Pandas**<br>• Modélisation et requêtage **SQL**</td>
      <td style="border: 1px solid #8B4513; vertical-align: top;">• Planification sur **MS Project**<br>• Modélisation de KPIs &amp; Benchmarks<br>• Gestion &amp; Audit des inventaires</td>
    </tr>
  </tbody>
</table>
