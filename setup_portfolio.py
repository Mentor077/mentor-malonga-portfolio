...
# 1. Définition du contenu du README.md Élite
readme_content = """# <p align="center">⚡ MENTOR MALONGA ⚡</p>
...
# 2. Définition du contenu de config.py
...
KPI_THRESHOLDS = {"SEUIL_ALERTE_STOCK_MIN": 15, "OBJECTIF_VENTES_MENSUEL": 500}
"""

# 3. Définition du contenu de requirements.txt
...
# 4. Création de l'arborescence et écriture des fichiers
print("🚀 Initialisation de l'environnement Data Portfolio pour Mentor Malonga...")
...
print("✅ README.md, config.py et requirements.txt générés avec succès !")
print("📁 Dossiers de données installés localement.")
